...
import 'editprofileuser_model.dart';
export 'editprofileuser_model.dart';
                                  ...
                                  builder: (context) => Container(
                                    ...
                                    child: CachedNetworkImage(
                                      imageUrl: valueOrDefault<String>(
                                        currentUserPhoto,
                                        'The default value for this variable if the resulting value is null or empty.',
                                      ),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                      ...
                      child: AuthUserStreamWidget(
                        builder: (context) => FlutterFlowDropDown<String>(
                          initialOption: _model.provinceValue ??=
                              valueOrDefault(currentUserDocument?.province, ''),
                          options: [
                            'İstanbul',
                            'Ankara',
                            'Bursa',
