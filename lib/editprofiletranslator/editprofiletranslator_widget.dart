...
import 'editprofiletranslator_model.dart';
export 'editprofiletranslator_model.dart';

class EditprofiletranslatorWidget extends StatefulWidget {
  const EditprofiletranslatorWidget({Key? key}) : super(key: key);

  @override
  _EditprofiletranslatorWidgetState createState() =>
      _EditprofiletranslatorWidgetState();
}

class _EditprofiletranslatorWidgetState
    extends State<EditprofiletranslatorWidget> {
  late EditprofiletranslatorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditprofiletranslatorModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final editprofiletranslatorUsersRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                      ...
                      SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                                        ...
                                        child: Container(
                                          ...
                                          child: CachedNetworkImage(
                                            imageUrl: valueOrDefault<String>(
                                              editprofiletranslatorUsersRecord
                                                  .photoUrl,
                            ...
                            Padding(
                              padding:
                              EdgeInsetsDirectional.fromSTEB(20, 0, 20, 7),
                              ...
                              child: AuthUserStreamWidget(
                                builder: (context) =>
                                    FlutterFlowDropDown<String>(
                                      initialOption: _model.provinceValue ??=
                                          valueOrDefault(
                                              currentUserDocument?.province, ''),
                                      options: [
                                        'İstanbul',
                                        'Ankara',
                                        'Bursa',
                            ...
                            Padding(
                              ...
                              child: FlutterFlowDropDown<String>(
                                initialOption: _model.sectorValue ??=
                                    editprofiletranslatorUsersRecord.sector,
                                options: [
                                  'Health care',
                                  'Business',
                                  'Education',
                            ...
                            Padding(
                              ...
                              EdgeInsetsDirectional.fromSTEB(20, 0, 20, 7),
                              child: FlutterFlowDropDown<String>(
                                initialOption: _model.priceValue ??=
                                    editprofiletranslatorUsersRecord.price,
                                options: [
                                  '100 - 200 TL',
                                  '200 - 300 TL',
                                  '300 - 500 TL',
                            ...
                            Padding(
                              padding:
                              EdgeInsetsDirectional.fromSTEB(20, 0, 0, 7),
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                  ...
                                  onPressed: () async {
                                    ...
                                    createUsersRecordData(
                                      ...
                                      certifacte: _model.uploadedFileUrl2 !=
                                          ...
                                          ? _model.uploadedFileUrl2
                                          : valueOrDefault(
                                          currentUserDocument?.certifacte,
                                          ''),
